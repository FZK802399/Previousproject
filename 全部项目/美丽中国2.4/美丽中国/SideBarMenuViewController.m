...
- (void)resetNavButtons
{
    ...
    if (menuFlags.canShowLeft) {
        UIImage *buttonImageNormal = [UIImage imageNamed:@"nav_back_btn_normal.png"];
        UIImage *buttonImageHighlight = [UIImage imageNamed:@"nav_back_btn_highlight.png"];
        UIButton *leftButton = [[UIButton alloc] initWithFrame:CGRectMake(-20.0f, 0.0f, buttonImageNormal.size.width/2, buttonImageNormal.size.height/2)];

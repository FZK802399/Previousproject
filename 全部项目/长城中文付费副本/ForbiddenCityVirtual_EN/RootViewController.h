...
@interface RootViewController : UIViewController<UIWebViewDelegate, UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate,CLLocationManagerDelegate, SinaWeiboDelegate, TCWeiboShareDelegate,SinaWeiboRequestDelegate>
{

...
@synthesize canChangeSoundFile = _canChangeSoundFile;
...
- (void)dealloc
{
    ...
    [_timer invalidate];
    [_slider removeObserver:self forKeyPath:@"value" context:nil];
...
+ (id)getInstance
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        audioPlayer.canChangeSoundFile = YES;
    });
    return audioPlayer;
}

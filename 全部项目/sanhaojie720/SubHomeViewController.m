...
-(IBAction)showIndustry:(id)sender {
    industry.whichView = ((UIButton *)sender).tag;
    [self.navigationController pushViewController:industry animated:YES];
    
}

-(IBAction)showVirtualTour:(id)sender {
    virtualTour.whichView = ((UIButton *)sender).tag;
    [self.navigationController pushViewController:virtualTour animated:YES];
...
- (void)viewDidLoad {
    ...
    self.industry = [[[Industry alloc] initWithNibName:@"Industry" bundle:nil] autorelease];
    self.virtualTour = [[[VirtualTour alloc] initWithNibName:@"VirtualTour" bundle:nil] autorelease];
    
    self.toolBar.tintColor = [UIColor colorWithRed:19.0f/255.0f green:134.0f/255.0f blue:200.0f/255.0f alpha:0.5f];
    
    UIImageView *barBackgroundView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 44)];
    barBackgroundView.image = [UIImage imageNamed:@"Title.png"];
    [self.navigationController.toolbar insertSubview:barBackgroundView atIndex:0];
	...
	switch (whichView) {
		case 1:
			self.title = @"IT产业";
			TopPaidAppsFeed = [NSString stringWithFormat:@"http://%@/sanhaojie_vtour/xml/cat1.xml", WEBADDRESS, whichView];
		//	NSLog(@"TopPaidAppsFeed= %@", [NSString stringWithFormat:@"http://%@/qjbj/index.php?catid=%d", WEBADDRESS, whichView]);
			break;
		case 2:
			self.title = @"文化产业";
			TopPaidAppsFeed = [NSString stringWithFormat:@"http://%@/sanhaojie_vtour/xml/cat2.xml", WEBADDRESS, whichView];
			break;
		case 3:
			self.title = @"服务产业";
		
			TopPaidAppsFeed = [NSString stringWithFormat:@"http://%@/sanhaojie_vtour/xml/cat3.xml", WEBADDRESS, whichView];
		...
		case 4:
			...
			TopPaidAppsFeed = [NSString stringWithFormat:@"http://%@/sanhaojie_vtour/xml/cat4.xml", WEBADDRESS, whichView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  /*  
   UIImageView *contentView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 138, 102)];
   [cell.icon addSubview:contentView];

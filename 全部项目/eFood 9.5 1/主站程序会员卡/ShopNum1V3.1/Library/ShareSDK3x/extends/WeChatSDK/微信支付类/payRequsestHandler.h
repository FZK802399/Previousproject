...
//#define APP_ID          @"wxadce5f538d0a0c9e"               //APPID
//#define APP_SECRET      @"7d00d4084ed1adf556767552cd141669" //appsecret
////商户号，填写商户对应参数
//#define MCH_ID          @"1242834202"
//商户API密钥，填写相应参数
//#define PARTNER_ID      @""
//支付结果回调页面
...
///签名实例测试 价格是分
- ( NSMutableDictionary *)sendPayWithTitle:(NSString*)title orderPrice:(NSString*)price;

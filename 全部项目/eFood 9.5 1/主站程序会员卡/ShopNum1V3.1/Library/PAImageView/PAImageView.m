...
- (void)updateWithImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholderImage animated:(BOOL)animated {
    ...
    [_containerImageView setImageWithURL:url placeholderImage:placeholderImage];

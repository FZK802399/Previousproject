...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor whiteColor]] forState:UIControlStateHighlighted];
        ...
        [xButton setImage:[UIImage imageNamed:@"btn_close_nal.png"] forState:UIControlStateNormal];

...
- (void)initTheInterface
{
    ...
    self.titleName.frame = CGRectMake(0, 11, xWidth, 32.0f);
    self.titleName.backgroundColor = [UIColor clearColor];
    [self addSubview:self.titleName];
    
    UIButton * closeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [closeBtn setImage:[UIImage imageNamed:@"btn_close_nal.png"] forState:UIControlStateNormal];
    [closeBtn setImage:[UIImage imageNamed:@"btn_close_selected.png"] forState:UIControlStateHighlighted];
    closeBtn.frame = CGRectMake(xWidth - 42, 8, 32, 32);
    [closeBtn addTarget:self action:@selector(dismiss) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:closeBtn];
    
    CGRect tableFrame = CGRectMake(0, 53, xWidth, self.bounds.size.height-50.0f);
    ...
    self.mainPopoverListView.backgroundColor = [UIColor clearColor];
